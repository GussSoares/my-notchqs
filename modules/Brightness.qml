...
RowLayout {
    ...
    function getBrightnessIcon() {
        ...
        if (brightness > 0 && brightness <= 10) return "󰃞 "
        if (brightness > 10 && brightness <= 50) return "󰃝 "
        if (brightness > 50 && brightness <= 90) return "󰃟 "
        if (brightness > 90 && brightness <= 100) return "󰃠 "
    }
